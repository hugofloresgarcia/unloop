...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 699.0, 26.881755056892416, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 685.0, 55.0, 32.0, 22.0 ],
					"text" : "s kill"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 482.0, 7.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 421.0, 7.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 362.0, 9.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 566.0, 41.0, 44.0, 22.0 ],
					"text" : "s clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 478.0, 41.0, 41.0, 22.0 ],
					"text" : "s stop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 413.0, 41.0, 40.0, 22.0 ],
					"text" : "s play"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 41.0, 35.0, 22.0 ],
					"text" : "s rec"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 231.000001192092896, 132.942279553749131, 613.0, 697.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.000001192092896, 132.942279553749131, 665.0, 760.0 ],
					"varname" : "vamper[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 907.000001192092896, 125.942279553749131, 613.0, 697.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 804.447202086448669, 98.391067862510681, 665.0, 760.0 ],
					"varname" : "vamper",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 88.000001192092896, 77.782124876976013, 136.0, 30.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 159.551657786003148, 312.633641815521287, 136.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 55.334023584953343, 5.881755056892416, 45.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 69.550594677558934, 312.633641815521287, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 312.000007271766663, 923.457546206581355, 44.0, 44.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 69.550594677558934, 390.184027625091517, 44.0, 44.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1::obj-133" : [ "live.gain~[4]", "live.gain~", 0 ],
			"obj-1::obj-19" : [ "live.gain~[3]", "live.gain~", 0 ],
			"obj-1::obj-62" : [ "temperature[1]", "temperature", 0 ],
			"obj-1::obj-67" : [ "periodic prompt[1]", "periodic prompt", 0 ],
			...
			"obj-5::obj-19" : [ "live.gain~", "live.gain~", 0 ],
			"obj-5::obj-62" : [ "temperature", "temperature", 0 ],
			"obj-5::obj-67" : [ "periodic prompt", "periodic prompt", 0 ],
...
,
				"obj-1::obj-67" : 				{
					"parameter_longname" : "periodic prompt[1]"
				}
,
				"obj-1::obj-69" : 				{
